...
function mapObject<Item extends IterableObject>(
  inputObject: Item,
  iteratee: (objectItem: Item[keyof Item], objectKey: string, c: Item) => Item[keyof Item],
  context?: unknown,
): Item {
...
function mapArray<Item>(
  array: Item[],
  iteratee: (arrayItem: Item, index: number, array: Item[]) => Item,
  context?: unknown,
): Item[] {
